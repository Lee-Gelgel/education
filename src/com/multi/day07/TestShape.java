...
public class TestShape {
	...
	public static void main(String args[]) {
		...
		BigDecimal bd = new BigDecimal(s[0].calculateArea());
		System.out.println(bd.setScale(5, 2));

	}
}
// Shape 0 is a BLUE Circle with an area of 314.15927, a radius of 10.0, and a
// perimeter of 62.831854
// Shape 1 is a RED Rectangle with an area of 35.0 and a perimeter of 24.0
// Shape 2 is a GREEN Circle with an area of 201.0619328, a radius of 8.0, and a
// perimeter of 50.2654832
